 ...
 */
export class LiigadokuHosting extends Construct {
    constructor(parent: Construct, id: string, props: Props) {
        super(parent, id);

        const zone = route53.HostedZone.fromLookup(this, 'hosted-zone', {domainName: props.hostedZoneName});
        ...
        const certificateArn = new acm.DnsValidatedCertificate(this, 'site-certificate', {
        ...
        new route53.ARecord(this, 'site-alias-record-01', {
        ...
        if(props.includeWWW) {
            new route53.ARecord(this, 'site-alias-record-02', {
